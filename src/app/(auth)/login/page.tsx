    ...
    >
      ...
      <div className="glass-strong rounded-2xl p-8 space-y-5">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-[var(--border-default)] text-sm font-medium text-gray-200 hover:bg-white/5 transition-all disabled:opacity-50"
        >
          {isGoogleLoading ? (
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-20 bg-[var(--bg-primary)]">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/3 w-72 h-72 bg-purple-700/15 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/3 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl" />
      </div>

      <Suspense
        fallback={
          <div className="text-center text-gray-400">Loading sign in...</div>
        }
      >
        <LoginFormContent />
      </Suspense>
